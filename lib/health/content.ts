...
export const healthQuestionSummaries: HealthQuestionSummary[] = [
  {
    ...
    seekCare: "코골이, 숨 막힘, 아침 두통, 주간 졸림이 함께 있으면 수면무호흡 평가가 필요할 수 있습니다.",
  },
  {
    ...
    seekCare: "흉통, 어지럼, 호흡곤란, 비정상적인 심계항진이 운동 중 동반되면 즉시 중단하고 진료를 받아야 합니다.",
  },
  {
    id: "diet-stability",
    category: "식단",
    ...
    seekCare: "급격한 체중 변화, 반복적인 폭식, 섭식 후 죄책감이 크다면 전문가 상담이 도움이 될 수 있습니다.",
  },
  {
    id: "desk-posture",
    category: "생활 습관",
    ...
    seekCare: "저림, 근력 저하, 밤에 깨는 통증, 외상 이후 통증이 있으면 일반적인 생활 교정보다 진료가 우선입니다.",
  },
];
